...
out_dir = 'E:\同步\p23_GNS-Ni_Ti_AGG_2024\exp_data\ebsd_ang\';
time_points = [5.0, 10.0, 20.0, 30.0];
local_names = {'level1', 'level2', 'level1a2','excerpt'};

num_type_figures = 2;
for i_time = 2:2 % length(time_points)
    % path to files
    ...
    % % output ang
    % output_file = fullfile(out_dir, sprintf('Ni_%dmin_%s.ang', time_points(i_time), local_names{3}));
...
% E:\Github\PandaScripts\p23-GNSNi-2024\a_experiments\exp2_draw_ipf_level1a2.m
